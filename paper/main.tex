...
\author{
\IEEEauthorblockN{Ícaro Adriano}
\IEEEauthorblockA{609310\\Dep.\ de Eng.\ de Teleinformática\\Universidade Federal do Ceará}
\and
\IEEEauthorblockN{Matheus Reis}
\IEEEauthorblockA{571954\\Dep.\ de Eng.\ de Teleinformática\\Universidade Federal do Ceará}
\and
\IEEEauthorblockN{Alisson Jaime}
\IEEEauthorblockA{555083\\Dep.\ de Eng.\ de Teleinformática\\Universidade Federal do Ceará}
\and
\IEEEauthorblockN{Vinícius A. G. do Nascimento}
\IEEEauthorblockA{568594\\Dep.\ de Eng.\ de Teleinformática\\Universidade Federal do Ceará}
}
...
worldwide \cite{idf2021}. TODO: magnitude, custo, e por que a
deteccao precoce muda o desfecho clinico.

% --- P2: por que analise exploratoria antes de modelagem.
% Este paragrafo justifica a existencia do trabalho.
TODO: antes de ajustar qualquer classificador, a estrutura dos dados
precisa ser compreendida; estatistica descritiva e projecao linear
revelam redundancia, escala, outliers e separabilidade.
...
TODO: dados sinteticos sao usados por privacidade, volume e ensino
\cite{synthetic2021}; a limitacao e que o processo gerador pode nao
preservar as dependencias do fenomeno real. Declarar explicitamente
aqui que o dataset analisado e sintetico \cite{kaggle2024}.

% --- P4: objetivo e organizacao do artigo.
TODO: objetivo do trabalho e mapa das secoes.
...
TODO: comentar que a classe \emph{Low}, com 470 observacoes contra
36{,}593 da classe \emph{High}, uma razao de 78 para 1, torna
instaveis as estatisticas condicionais dessa classe e seria um
problema serio para qualquer classificacao futura.
...
TODO: destacar que quatro deles apresentam \emph{exatamente} mil
ausencias cada, e que os quatro sao precisamente o painel lipidico
completo (colesterol total, HDL, LDL e triglicerideos). Perda natural
de registro nao produz um numero redondo identico em quatro variaveis
correlacionadas por exame; o padrao indica injecao deliberada de
ausencias em bloco pelo gerador.
...
TODO: (i) padronizacao para media zero e variancia unitaria antes do
PCA, justificada pelas escalas heterogeneas (mg/dL, kg, cm, anos), sem
a qual os preditores de maior escala dominariam a matriz de
covariancia; (ii) remocao das linhas com valor ausente antes do PCA,
exigida pela estimativa da matriz de covariancia, que reduz a amostra
de $50{,}000$ para $33{,}689$ observacoes, isto e, $32.6\%$ dos dados
descartados. Declarar isso como limitacao: a analise multivariada
descreve um subconjunto completo, nao a coorte inteira. As estatisticas
univariadas e bivariadas usam todas as observacoes disponiveis por
preditor.
...
\label{eq:skew}
\end{equation}
% TODO: dizer o que a assimetria informa (cauda, desvio da gaussiana).
