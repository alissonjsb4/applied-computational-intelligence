...
from predefined uniform distributions.
...
independent uniform variables is not itself uniform. This isolated
behaviour is the first of three analytical signals that will converge
in Section~\ref{subsec:pca}.
...
and no pair of variables separates the classes visually.
...
explained only by the rules of the generating process. This is the
second signal of the artificial nature of the relationships the
dataset contains.
